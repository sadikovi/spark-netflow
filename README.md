...
|---------------|------------------------------|
| 1.4+ | [1.3.1](http://spark-packages.org/package/sadikovi/spark-netflow) |
...
```shell
 $SPARK_HOME/bin/spark-shell --packages sadikovi:spark-netflow:1.3.1-s_2.10
```
Change to `sadikovi:spark-netflow:1.3.1-s_2.11` for Scala 2.11.x
...
$ spark-submit --class com.github.sadikovi.spark.benchmark.NetFlowReadBenchmark \
  target/scala-2.10/spark-netflow_2.10-1.3.1.jar \
  --iterations 5 \
