...
public final class PredicateRecordMaterializer extends RecordMaterializer {
  public PredicateRecordMaterializer(Column[] columns, Column[] filtered, FilterPredicate tree) { }
