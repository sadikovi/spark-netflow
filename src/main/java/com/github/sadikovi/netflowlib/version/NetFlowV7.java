...
public class NetFlowV7 extends NetFlow {
  ...
  // Reason flow discarded, etc, size: 1
  public static final ShortColumn FIELD_FLAGS = new ShortColumn("flags", 55);
  ...
  public static final LongColumn FIELD_ROUTER_SC = new LongColumn("router_sc", 64);
